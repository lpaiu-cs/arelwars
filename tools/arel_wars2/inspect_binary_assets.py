...
from formats import find_zlib_streams, read_pzx_first_stream, read_pzx_row_stream  # noqa: E402

try:
    from formats import read_ptc  # type: ignore[attr-defined]  # noqa: E402
except ImportError:
    ...
    def read_ptc(data: bytes) -> PtcFile | None:
        ...
        return PtcFile(
            ...
            fields_i16=tuple(_u16_to_i16(value) for value in fields_u16),
